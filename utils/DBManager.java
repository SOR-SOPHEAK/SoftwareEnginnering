...
public class DBManager{
    ...
    private DBManager(String db, String user, String pass, int port, String host){
        try {
            conn = DriverManager.getConnection("jdbc:mysql://"+host+":"+port+"/"+db, user, pass);//connect to db
        } catch (SQLException e) {
            throw new DBException(e);//optional exception ber connect ban ot error ber connect ot ban error (jg catch kr ban ot kr ban)
        }
    }
